    ...
    <Box bg={bg}>
      ...
      >
        ...
        <Text mt="2" maxW="xl" fontSize="md" color="gray.400">
          Want to hear from us when we add new components? Sign up for our newsletter and we&#x27;ll
          email you every time we release a new batch of components.
        </Text>
        ...
        >
          <picture>
            <source srcSet="/images/tailwind/object/5.webp" type="image/webp" />
            <source srcSet="/images/tailwind/object/5.png" />
            <Image
              w="50%"
              objectFit="cover"
              maxW="44"
              mx="auto"
              src="/images/tailwind/object/5.png"
              alt="shopping item"
            />
          </picture>
        </Box>
