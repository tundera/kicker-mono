    ...
    >
      <Box w={{ xl: '0' }} flex={{ xl: '1 1 0%' }}>
        ...
        <Text mt="3" maxW="3xl" fontSize="lg" lineHeight="6" color="indigo.200">
          No account or email required. We use push notifications. You can choose between several
          modes and define your own alert threshold.
        </Text>
      </Box>
      <Box mt={{ base: '8', xl: '0' }} ml={{ xl: '8' }} w={{ sm: 'full' }} maxW={{ sm: 'md' }}>
        ...
        <Text mt="3" fontSize="sm" lineHeight="5" color="indigo.200">
          We care about the protection of your data. Your data is safe and never used for commercial
          purposes.
        </Text>
