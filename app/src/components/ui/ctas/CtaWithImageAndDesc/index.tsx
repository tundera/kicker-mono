import { Box, chakra, Heading, Image, Text,useColorModeValue } from '@chakra-ui/react'
    ...
    <Box bg={bg} overflow="hidden" position="relative">
      ...
      >
        ...
        <Text fontSize="xl" mt="4" color="gray.400">
          I had noticed that both in the very poor and very rich extremes of society the mad were
          often allowed to mingle freely
        </Text>
