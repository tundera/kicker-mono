...
const WatchCta: FC = () => {
  ...
  return (
    <Flex bg={bg} position="relative" alignItems="center" overflow="hidden" zIndex="10">
      <Flex
        position="relative"
        px="6"
        py="16"
      ...
      >
        ...
        <Box
          ...
          w={{ sm: '33.333333%', lg: '60%' }}
        >
          <Image src="/images/tailwind/object/10.png" maxW={{ base: 'xs', md: 'sm' }} m="auto" />
        </Box>
      </Flex>
    </Flex>
  )
