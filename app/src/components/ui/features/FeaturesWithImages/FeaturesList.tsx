import { Box, Flex, Heading, Icon,List, ListItem, Text, useColorModeValue } from '@chakra-ui/react'
      ...
      <ListItem mt="10">
        <Flex>
          ...
          <Box ml="4">
            ...
            <Text mt="2" fontSize="md" color={detailColor} lineHeight="6">
              All your orders in one place so you can manage your delivery, collection, asap and
              pre-orders in one place.
            </Text>
          </Box>
        </Flex>
      </ListItem>
      <ListItem mt="10">
        <Flex>
          ...
          <Box ml="4">
            ...
            <Text mt="2" fontSize="md" color={detailColor} lineHeight="6">
              Never miss a new order with notifications via your dashboard, by sound, and to your
              email and phone.
            </Text>
          </Box>
        </Flex>
