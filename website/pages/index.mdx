...
This monorepo is built using [Yarn Workspaces](https://classic.yarnpkg.com/en/docs/workspaces/) and
[Preconstruct](https://preconstruct.tools/). These tools perform well with the majority of monorepos
focused on React, Node, and GraphQL (although not exclusive to this ecosystem).
